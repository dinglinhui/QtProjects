...
TransmitTab::TransmitTab(QWidget *parent) :
    QWidget(parent),
    treePopMenu(new QMenu(this)),
    tablePopMenu(new QMenu(this)),
    callAction(new QAction(QIcon(":/system/images/256/reload.png"), TRANSMIT_CALL, this)),
    printAction(new QAction(QIcon(":/system/images/256/print.png"), TRANSMIT_PRINT, this)),
    ...
    m_nTypeIndex(0)
{
    ...
    tableView->setModel(m_pAIModel[0]);
    ...
    tableView->setColumnWidth(TABLE_TRANSMITINFO_AI_INDEX, 80);
    tableView->setColumnWidth(TABLE_TRANSMITINFO_AI_INFOADDR, 80);
    tableView->setColumnWidth(TABLE_TRANSMITINFO_AI_IEDADDR, 80);
    tableView->setColumnWidth(TABLE_TRANSMITINFO_AI_DESC, 400);
    tableView->setContextMenuPolicy(Qt::CustomContextMenu);
    connect(tableView, SIGNAL(customContextMenuRequested(QPoint)), this, SLOT(onTableCustomContextMenuRequested(QPoint)));
...
TransmitTab::~TransmitTab(void)
{
    if(m_pPrinter != NULL)
        delete m_pPrinter, m_pPrinter = NULL;
}

QAbstractItemModel *TransmitTab::createAIModel(QObject *parent)
{
...
QAbstractItemModel *TransmitTab::createSoeBufferModel(QObject *parent)
{
...
QAbstractItemModel *TransmitTab::createCOSModel(QObject *parent)
{
...
QAbstractItemModel *TransmitTab::createDOModel(QObject *parent)
{
...
void TransmitTab::clearModel(int chnlIndex, int iedIndex, int typeIndex)
{
...
void TransmitTab::changeModel(int chnlIndex, int iedIndex, int typeIndex)
{
    ...
    case TRANSMIT_CHNL_S:
    {
        tableView->setModel(m_pAIModel[m_nChnlIndex]);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_AI_INDEX, 80);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_AI_INFOADDR, 80);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_AI_IEDADDR, 80);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_AI_DESC, 400);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_AI_THRESHOLD_TYPE, 80);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_AI_THRESHOLD, 80);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_AI_OFFSET, 80);
        break;
    }
    case TRANSMIT_COS:
    {
        tableView->setModel(m_pCOSModel[m_nChnlIndex]);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_COS_INDEX, 80);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_COS_INFOADDR, 80);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_COS_IEDADDR, 80);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_COS_DESC, 400);
        break;
    }
    case TRANSMIT_DO:
    {
        tableView->setModel(m_pDOModel[m_nChnlIndex]);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_DO_INDEX, 80);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_DO_INFOADDR, 80);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_DO_IEDADDR, 80);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_DO_DESC, 400);
        break;
    }
    case SOE_BUFFER_CHNL:
    {
        tableView->setModel(m_pSoeBufferModel[m_nChnlIndex][m_nIedIndex]);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_SOE_BUFFER_TYPE, 60);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_SOE_BUFFER_INDEX, 60);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_SOE_BUFFER_OLDEST, 60);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_SOE_BUFFER_DESC, 400);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_SOE_BUFFER_VALUE, 50);
        tableView->setColumnWidth(TABLE_TRANSMITINFO_SOE_BUFFER_QUALITY, 150);
//        tableView->setColumnWidth(TABLE_TRANSMITINFO_SOE_BUFFER_TIME, 200);
        break;
    }
    default:
        break;
...
void TransmitTab::printTransmit()
{
    QPrinter printer;
...
void TransmitTab::onPrint(QPrinter *pPrinter)
{
...
void TransmitTab::onCallTriggered()
{
    emit callSignl();
}

void TransmitTab::onExportExcelTriggered()
{
...
void TransmitTab::onExportCsvTriggered()
{
    QFileDialog::Options options;
    QString selectedFilter;
    QString masterName;
...
void TransmitTab::onTreeCustomContextMenuRequested(QPoint pos)
{
...
void TransmitTab::onTableCustomContextMenuRequested(QPoint pos)
{
...
void TransmitTab::displayTransmitTable(const QByteArray &buffer, int dbIndex)
{
    char pText[128];
